...
local L = LANG.CreateLanguage("Xmas")
...
L.terrorists = "Boys and Girls"
L.spectators = "Mummy and Daddy"
...
L.round_selected   = "The Grinches have been selected."
L.round_started    = "The round has begun!"
L.round_restart    = "The round has been forced to restart by an admin."

L.round_traitors_one  = "Grinch, you stand alone."
L.round_traitors_more = "Grinch, these are your allies: {names}"

L.win_time         = "Time has run out. The Grinches lose."
L.win_traitor      = "The Grinches have won!"
L.win_innocent     = "The Grinches have been defeated!"
...
--- Credit awards
L.credit_det_all   = "Santas, you have been awarded {num} equipment credit(s) for your performance."
L.credit_tr_all    = "Grinches, you have been awarded {num} equipment credit(s) for your performance."
...
L.body_found_t     = "He was a Grinch!"
L.body_found_d     = "He was a Santa."
L.body_found_i     = "He was an elf."

L.body_confirm     = "{finder} confirmed the death of {victim}."

L.body_call        = "{player} called a Santa to the body of {victim}!"
L.body_call_error  = "You must confirm the death of this player before calling a Santa!"
...
L.disg_help1     = "When your disguise is active, your name, happiness and karma do not show when someone looks at you. In addition, you will be hidden from a Santa's radar."
...
L.inno_globalchat_hint = "When an elf, use global chat to communicate."
...
L.quick_traitor = "{player} is a Grinch!"
L.quick_inno    = "{player} is an elf."
...
L.search_call   = "Call Santa"

-- Descriptions of pieces of information found
L.search_nick   = "This is the body of {player}."

L.search_role_t = "This person was a Grinch!"
L.search_role_d = "This person was Santa."
L.search_role_i = "This person was an elf."
...
L.search_dmg_tele   = "It looks like his Naughtyness was forgotten about!"
...
L.search_dna    = "Retrieve a sample of the killer's Naughtyness with a Naughty List. The Naughtyness sample will decay roughly {time} from now."
...
L.search_eyes   = "Using your santa skills, you identified the last person he saw: {player}. The killer, or a coincidence?"
...
L.set_healthlabel   = "Show happiness status label on happiness bar"
...
L.c4_no_disarm    = "You cannot disarm another Grinch's C4 unless he is dead."
...
L.c4_disarm_t     = "Cut a wire to disarm the bomb. As you are a Grinch, every wire is safe. Elves don't have it so easy!"
...
L.vis_hint        = "Press {usekey} to pick up (Santa only)."
...
L.decoy_desc      = [[
Shows a fake radar sign to santas,
and makes their Naughty list show the
...
-- Health station
L.hstation_name   = "Happiness Present"
L.hstation_hint   = "Press {usekey} to open the present and gain happiness. Charge: {num}."
L.hstation_broken = "Your Happiness Present has been destroyed!"
L.hstation_help   = "{primaryfire} places the Happiness Present."

L.hstation_desc   = [[
Allows people to heal when opened before Christmas.

Slow recharge. Anyone can use it, and
it can be damaged. Can be checked for
Naughtyness of its users.]]
...
-- DNA scanner
L.dna_name        = "Naughty List"
L.dna_identify    = "Corpse must be identified to retrieve killer's Naughtyness."
L.dna_notfound    = "No Naughtyness sample found on target."
L.dna_limit       = "Storage limit reached. Remove old samples to add new ones."
L.dna_decayed     = "Naughtyness of the killer has decayed."
L.dna_killer      = "Collected a sample of the killer's Naughtyness from the corpse!"
L.dna_no_killer   = "The Naughtyness could not be retrieved (killer disconnected?)."
L.dna_armed       = "This bomb is live! Disarm it first!"
L.dna_object      = "Collected {num} new Naughtyness sample(s) from the object."
L.dna_gone        = "Naughtyness not detected in area."

L.dna_desc        = [[
Collect Naughtyness samples from things
and use them to find the Naughty person.

Use on fresh corpses to get the killer's Naughtyness
and track him down.]]

L.dna_menu_title  = "Naughtyness scanning controls"
L.dna_menu_sample = "Naughtyness sample found on {source}"
L.dna_menu_remove = "Remove selected"
L.dna_menu_help1  = "These are Naughtyness samples you have collected."
L.dna_menu_help2  = [[
...
L.dna_help_primary   = "{primaryfire} to collect a Naughtyness sample"
...
L.hp_healthy   = "Very Happy!"
L.hp_hurt      = "Happy"
L.hp_wounded   = "Sad"
L.hp_badwnd    = "Upset"
L.hp_death     = "Miserable"


-- TargetID karma status
L.karma_max    = "Good little boy/girl"
L.karma_high   = "Bad little boy/girl"
L.karma_med    = "Naughty little boy/girl"
L.karma_low    = "Very naughty little boy/girl"
L.karma_min    = "Getting coal for Christmas"
...
L.target_traitor = "FELLOW GRINCH"
L.target_detective = "SANTA"
...
L.info_popup_innocent = [[You are an elf! But there are grinches around...
...
L.info_popup_detective = [[You are Santa! The North Pole has given you special resources to find the grinches.
Use them to help the elves survive, but be careful:
the grinches will be looking to take you down first!

Press {menukey} to receive your equipment!]]

L.info_popup_traitor_alone = [[You are a GRINCH! You have no fellow grinches this round.

Kill all others to win!

Press {menukey} to receive your special equipment!]]

L.info_popup_traitor = [[You are a GRINCH! Work with fellow grinches to kill all others.
...
L.tip1 = "Grinches can search a corpse silently, without confirming the death, by holding {walkkey} and pressing {usekey} on the corpse."

L.tip2 = "Arming a C4 explosive with a longer timer will increase the number of wires that cause it to explode instantly when an elf attempts to disarm it. It will also beep softer and less often."

L.tip3 = "Santa can search a corpse to find who is 'reflected in its eyes'. This is the last person the dead guy saw. That does not have to be the killer if he was shot in the back."

L.tip4 = "No one will know you have died until they find your dead body and identify you by searching it."

L.tip5 = "When a Grinch kills Santa, he instantly receives a credit reward."

L.tip6 = "When a Grinch dies, Santa is rewarded equipment credits."

L.tip7 = "When the Grinches have made significant progress in killing elves, they will receive an equipment credit as reward."

L.tip8 = "Grinches and Santa can collect unspent equipment credits from the dead bodies of other Grinches and Santas."
...
L.tip10 = "As Grinch or Santa, keep an eye on red messages in the top right. These will be important for you."

L.tip11 = "As Grinch or Santa, keep in mind you are rewarded extra equipment credits if you and your comrades perform well. Make sure you remember to spend them!"

L.tip12 = "Santas' Naughty List can be used to find bad little boys and girls from weapons and items and then scan to find the location of the player who used them. Useful when you can get a sample from a corpse or a disarmed C4!"

L.tip13 = "When you are close to someone you kill, some of your Naughtyness is left on the corpse. This Naughtyness can be used with Santa's Naughty list to find your current location. Better hide the body after you knife someone!"

L.tip14 = "The further you are away from someone you kill, the faster your Naughtyness will be forgotten."

L.tip15 = "Are you Grinch and going sniping? Consider trying out the Disguiser. If you miss a shot, run away to a safe spot, disable the Disguiser, and no one will know it was you who was shooting at them."

L.tip16 = "As a Grinch, the Teleporter can help you escape when chased, and allows you to quickly travel across a big map. Make sure you always have a safe position marked."

L.tip17 = "Are the elves all grouped up and hard to pick off? Consider trying out the Radio to play sounds of C4 or a firefight to lead some of them away."

L.tip18 = "Using the Radio as a Grinch, you can play sounds through your Equipment Menu after the radio has been placed. Queue up multiple sounds by clicking multiple buttons in the order you want them."

L.tip19 = "As Santa, if you have leftover credits you could give a trusted Elf a Defuser. Then you can spend your time doing the serious investigative work and leave the risky bomb defusal to them."

L.tip20 = "Santas' Binoculars allow long-range searching and identifying of corpses. Bad news if the Grinches were hoping to use a corpse as bait. Of course, while using the Binoculars, Santa is unarmed and distracted..."

L.tip21 =  "Santas' Presents make little boys and girls happy. Of course, those unhappy people could be Grinches..."

L.tip22 = "Santas' presents record a naughtyness sample of everyone who opens it. Santa can use this with the Naughty list to find out who has been opening their presents before Christmas."

L.tip23 = "Unlike weapons and C4, the Radio equipment for Grinches does not record the Naughtyness of the person who planted it. Don't worry about Santa finding it and blowing your cover."
...
L.tip25 = "When Santa searches a body, the result is available to all players via the scoreboard by clicking on the name of the dead person."

L.tip26 = "In the scoreboard, a magnifying glass icon next to someone's name indicates you have search information about that person. If the icon is bright, the data comes from Santa and may contain additional information."

L.tip27 = "As Santa, corpses with a magnifying glass after the nickname have been searched by Santa and their results are available to all players via the scoreboard."
...
L.tip35 = "As a Grinch, remember you can carry dead bodies and hide them from the prying eyes of Santa and his elves."
...
L.tip40 = "If it says 'HASTE MODE' above the round timer, the round will at first be only a few minutes long, but with every death the available time increases (like capturing a point in TF2). This mode puts the pressure on the grinches to keep things moving."
...
-- Big title window
L.hilite_win_traitors = "COAL FOR EVERYONE"
L.hilite_win_innocent = "XMAS IS SAVED!"

L.hilite_players1 = "{numplayers} players took part, {numtraitors} were grinches"
L.hilite_players2 = "{numplayers} players took part, one of them the grinch"
...
L.col_player = "Player"
L.col_role   = "Role"
L.col_kills1 = "Elf kills"
L.col_kills2 = "Grinch kills"
L.col_points = "Points"
...
L.ev_win_traitor = "The dastardly grinches won the round!"
L.ev_win_inno    = "The lovable elves won the round!"
L.ev_win_time    = "The grinches ran out of time and lost!"
...
L.aw_fst1_text  = "delivered the first elf death at a grinch's hands."

L.aw_fst2_title = "First Bloody Stupid Kill"
L.aw_fst2_text  = "scored the first kill by shooting a fellow grinch. Good job."

L.aw_fst3_title = "First Blooper"
L.aw_fst3_text  = "was the first to kill. Too bad it was an elf comrade."

L.aw_fst4_title = "First Blow"
L.aw_fst4_text  = "struck the first blow for the elves by making the first death a grinch's."

L.aw_all1_title = "Deadliest Among Equals"
L.aw_all1_text  = "was responsible for every kill made by the elves this round."

L.aw_all2_title = "Lone Wolf"
L.aw_all2_text  = "was responsible for every kill made by a grinch this round."

L.aw_nkt1_title = "I Got One, Boss!"
L.aw_nkt1_text  = "managed to kill a single elf. Sweet!"

L.aw_nkt2_title = "A Bullet For Two"
L.aw_nkt2_text  = "showed the first one was not a lucky shot by killing another."

L.aw_nkt3_title = "Serial Grinch"
L.aw_nkt3_text  = "ended three elf lives today."

L.aw_nkt4_title = "Wolf Among More Sheep-Like Wolves"
L.aw_nkt4_text  = "eats elves for dinner. A dinner of {num} courses."
...
L.aw_nki1_text  = "found a grinch. Shot a grinch. Easy."

L.aw_nki2_title = "Applied to the Justice Squad"
L.aw_nki2_text  = "escorted two grinches to the great beyond."

L.aw_nki3_title = "Do Grinches Dream Of Grinch Sheep?"
L.aw_nki3_text  = "put three grinches to rest."
...
L.aw_knf2_text  = "was not a Grinch, but still killed someone with a knife."
...
L.aw_tkl2_text  = "thought he got a Grinch twice, but he was wrong both times."
...
--- v23
L.set_avoid_det     = "Avoid being selected as Santa"
L.set_avoid_det_tip = "Enable this to ask the server not to select you as Santa if possible. Does not mean you are Grinch more often."
