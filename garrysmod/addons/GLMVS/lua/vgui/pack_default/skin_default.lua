...
SKIN.colTextEntryText = Color(220, 220, 220)
SKIN.colTextEntryTextHighlight = Color(0, 0, 0)
...
local texCorner = surface.GetTextureID("gui/mvcirclegradient")
...
derma.DefineSkin("GSkin_Default", "The default GLMVS Derma skin from Zombie Survival", SKIN, "Default") -- Renamed the skin to prevent override.