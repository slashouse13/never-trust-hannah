...
function IsValidImage( mapname )
	if file.Exists( "download/materials/nth/mapicons/" ..mapname.. ".png", "MOD" ) then
		return "../download/materials/nth/mapicons/" ..mapname.. ".png"
	end
    
    if file.Exists( "materials/nth/mapicons/" ..mapname.. ".png", "MOD" ) then
		return "materials/nth/mapicons/" ..mapname.. ".png"
	end
