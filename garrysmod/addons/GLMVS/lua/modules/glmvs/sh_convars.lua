...
/* ----------------------------------------
	Integers
---------------------------------------- */
CreateConVar( "nth_num_voteable_maps", 10, FCVAR_REPLICATED + FCVAR_ARCHIVE + FCVAR_NOTIFY, "Number of maps to choose from at end of round" )

SVotePower = CreateConVar( "glmvs_svotepower", 1, FCVAR_REPLICATED + FCVAR_ARCHIVE + FCVAR_NOTIFY, "Minimum vote power for the players." ):GetInt()
