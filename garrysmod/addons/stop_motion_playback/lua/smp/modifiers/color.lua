...
function MOD:LoadBetween(player, entity, data1, data2, percentage)
	...
	local r = SMP.LerpLinear(c1.r, c2.r, percentage);
	local g = SMP.LerpLinear(c1.g, c2.g, percentage);
	local b = SMP.LerpLinear(c1.b, c2.b, percentage);
	local a = SMP.LerpLinear(c1.a, c2.a, percentage);
